...
public class BackendAuthenticationFailureHandlerImpl implements AuthenticationFailureHandler {
    ...
    public void onAuthenticationFailure(HttpServletRequest request,
        ...
        //用户不存在时，抛出UsernameNotFoundException，但是会被转成BadCredentialsException
        ...
        //转换操作是在自定义的BackendDaoAuthentationProvider类的父类AbstractUserDetailsAuthenticationProvider中完成的
